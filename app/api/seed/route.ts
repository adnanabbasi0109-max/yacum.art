...
const artworks = [
  {
    ...
    translation: '"Take on Allah\'s colour." And whose colour is better than Allah\'s? It is Him that we serve.',
    theme: "Light",
    ...
    isFeatured: true,
    description: "A vast, ethereal desert landscape where divine light descends like a luminous waterfall, painting veins of colour through ancient stone. The barren earth awakens with subtle hues — a visual meditation on how Allah's colour transforms even the most desolate terrain into something sacred and alive.",
  },
  {
    ...
    translation: "They shall be in the midst of thornless lote trees.",
    theme: "Nature",
    ...
    isAuctionPiece: false,
    isFeatured: true,
    description: "A serene vision of Paradise: beneath thornless lote trees, the gardens glow with peace, soft light, and flowing streams, offering a glimpse of the comfort and beauty prepared for the blessed.",
  },
  {
    ...
    isAuctionPiece: false,
    isFeatured: false,
    description: "The perfection of Allah's creation: layered, balanced, and without fault. It invites the heart to look again and again, finding harmony, beauty, and signs of divine design in every detail.",
  },
  {
    ...
    isAuctionPiece: false,
    isFeatured: false,
    description: "The perfection of Allah's creation, where no flaw or imbalance can truly be found. Its delicate patterns invite the eye to look again and again, witnessing harmony, beauty, and divine precision in even the smallest part of nature.",
  },
  {
    ...
    isAuctionPiece: false,
    isFeatured: true,
    description: "A radiant sunflower stands as a gentle sign of divine perfection, where creation is described as flawless and harmonious. Its balanced petals, ordered center, and graceful form invite the heart to look again and witness the beauty, precision, and unity woven into Allah's design.",
  },
  {
    ...
    isAuctionPiece: false,
    isFeatured: false,
    description: "The creation of Allah is marked by balance, precision, and flawless design. The perfect geometry of the hexagonal cells invites the eye to look again and again, yet find no disorder, only beauty, wisdom, and proportion in what He has created.",
  },
  {
    ...
    isAuctionPiece: false,
    isFeatured: false,
    description: "A majestic canyon of layered mountains rises in flowing bands of gold, rose, and amber, while still pools of turquoise water rest below. The scene feels sculpted with precision and grandeur, capturing the quiet power and beauty of mountains raised in perfect measure.",
  },
  {
    ...
    translation: "Have they not seen birds above them spreading and closing their wings, with none holding them except the Merciful One? He oversees everything.",
    theme: "Mercy",
    ...
    isAuctionPiece: false,
    isFeatured: false,
    description: "Wings open and fold in perfect rhythm, yet nothing about their flight feels self-sustained. Beauty, motion, and mercy meet in a single breath of air.",
  },
];
