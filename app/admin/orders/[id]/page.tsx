...
const STATUSES = ["processing", "confirmed", "printing", "shipped", "delivered"];
const CARRIERS = ["India Post", "DTDC", "Delhivery", "BlueDart", "FedEx", "DHL", "Other"];
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-2">
          <span
            ...
            style={{ backgroundColor: statusColors[order.fulfillmentStatus] || "#666" }}
          />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="border border-[#c9a96e]/15 bg-[#0d0d0d] p-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className={order.paymentStatus === "paid" ? "text-[#4ade80]" : "text-[#facc15]"}>
            ...
            {order.shippingAddress && (
              <div className="mt-4 pt-4 border-t border-[#c9a96e]/10">
                <p className="text-[#e8e0d0]/40 text-xs mb-1">Shipping Address</p>
          ...
          <div className="border border-[#c9a96e]/15 bg-[#0d0d0d] p-6">
            ...
            {/* Add custom update */}
            <div className="mt-4 pt-4 border-t border-[#c9a96e]/10">
              <p className="text-[#e8e0d0]/40 text-xs mb-2">Add Custom Update</p>
